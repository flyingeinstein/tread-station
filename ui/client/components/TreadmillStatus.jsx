...
export default class TreadmillStatus extends React.Component {
    ...
    render() {
        return <g className="status">
            ...
            <text className="speed-indicator" textAnchor="middle" fontSize="160px" x="0" y="-320">{this.props.status.active ? Number(this.props.status.speed.current).toFixed(1) : ""}</text>
